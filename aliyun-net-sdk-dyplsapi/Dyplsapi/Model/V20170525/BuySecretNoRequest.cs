...
namespace Aliyun.Acs.Dyplsapi.Model.V20170525
{
    public class BuySecretNoRequest : RpcAcsRequest<BuySecretNoResponse>
    {
        public BuySecretNoRequest()
            : base("Dyplsapi", "2017-05-25", "BuySecretNo", "dyplsapi", "openAPI")
        {
        }
        ...
        public override BuySecretNoResponse GetResponse(Core.Transform.UnmarshallerContext unmarshallerContext)
        {
